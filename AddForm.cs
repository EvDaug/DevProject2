...
namespace SalesReportPredictionSystem
{
    public partial class AddForm : Form
    {
        ...
        private void AddRow()
        {
            ...
            if (!(tbName.Text == "") && !(tbBrand.Text == "") && !(tbCategory.Text == "") && !(tbSold.Text == "") && !(tbId.Text == ""))
            {
                String query = "INSERT INTO current_sales( id, item_name, brand_name, category, stock_sold) VALUES (\'" + tbId.Text+ "\',\'" + tbName.Text + "\',\'" + tbBrand.Text + "\',\'" + tbCategory.Text + "\',\'" + tbSold.Text+ "\')";
